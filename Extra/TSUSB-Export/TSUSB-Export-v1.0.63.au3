...
Global $TStimelogfile="TurtleSTimelog.txt"
...
Global $msgXMLDSTnamesNotMatchingFlag, $msgTooMuchTimeDiffFlag, $msgTooManyColorsFlag, $msgTooLargeFlag, $msgTooManyStitchesFlag, $msgNoStitchesFlag, $msgForbiddenNameFlag
...
Func SetMessagesInLanguage()
	...
	$msgCloudSavingFlag = 128
	$msgCloudSaving = " The .XML file should be saved to the cloud. Did you?"

	$msgXTooLargeFlag = 256
	$msgYTooLargeFlag = 512

	$msgForbiddenLabelFlag=1024
	...
	Else
		...
		For $i = 1 To $aArray[0]
			...
			If StringInStr($USBvolume, $USBstickPrefixTurtleSt, 1) = 1 Then
				...
				if $result <> 5 Then _WinAPI_EjectMedia($DriveLetter)
